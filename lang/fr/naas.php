...
$string["privacy:metadata:naas_activity_outcome"] = "Le plugin Nugget crée une session chaque fois qu'un utilisateur s'engage dans une activité Nugget.  Un Nugget est censé durer moins de 30 minutes. La session est automatiquement supprimée après 45 minutes.";
...
$string["privacy:metadata:naas_activity_outcome:id"] = "L'identifiant de la session utilisateur sur une instance particulière d'une activité Nugget.";
