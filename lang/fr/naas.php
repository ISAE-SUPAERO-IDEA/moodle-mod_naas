...
$string["naas:addinstance"] = "Ajouter un Nugget";
...
$string["privacy:metadata:naas_api"] = "Le plugin Nugget se connecte à l'API NaaS pour récupérer du contenu, soumettre des notes et suivre les interactions d'apprentissage. Cela peut impliquer l'envoi de données d'identification de l'utilisateur lorsque les paramètres de confidentialité le permettent.";
$string["privacy:metadata:naas_api:username"] = "Le nom d'utilisateur API utilisé pour l'authentification auprès du serveur NaaS.";
$string["privacy:metadata:naas_api:structure_id"] = "L'identifiant de structure identifiant votre organisation au sein de la plateforme NaaS.";
$string["privacy:metadata:naas_api:nugget_id"] = "L'identifiant du contenu nugget auquel on accède ou que l'on modifie.";
$string["privacy:metadata:naas_api:version_id"] = "L'identifiant de version du contenu nugget spécifique utilisé.";
$string["privacy:metadata:naas_api:user_data"] = "Données utilisateur qui peuvent être envoyées à la plateforme NaaS lorsque les paramètres de confidentialité le permettent.";
$string["privacy:metadata:naas_api:resource_link_id"] = "Un identifiant unique pour la ressource spécifique à laquelle l'utilisateur accède.";
