 ...
 *
 * @package$string[mod_naas
 * @copyright  1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license$string[http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['pluginname'] = 'NaaS';
$string['modulename'] = 'Nugget';
$string['modulename_help'] = 'Le plugin NaaS permet d\'intégrer un micro-contenu depuis le serveur NaaS.';
...
$string['naas_settings_help'] = 'Configurer la connexion au NaaS';
