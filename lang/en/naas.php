...
$string["privacy:metadata:naas_xapi"] = "The Nugget activity sends xAPI statements to the NaaS platform to track user interactions with the content.";
...
$string["privacy:metadata:naas_api"] = "The Nugget plugin connects to the NaaS API to retrieve content, submit grades, and track learning interactions. This may involve sending user identification data when privacy settings allow it.";
$string["privacy:metadata:naas_api:username"] = "The API username used for authentication with the NaaS server.";
$string["privacy:metadata:naas_api:structure_id"] = "The structure ID identifying your organization within the NaaS platform.";
$string["privacy:metadata:naas_api:nugget_id"] = "The ID of the nugget content being accessed or modified.";
$string["privacy:metadata:naas_api:version_id"] = "The version ID of the specific nugget content being used.";
$string["privacy:metadata:naas_api:user_data"] = "User data that may be sent to the NaaS platform when privacy settings allow it.";
$string["privacy:metadata:naas_api:resource_link_id"] = "A unique identifier for the specific resource being accessed by the user.";
